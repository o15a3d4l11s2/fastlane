...
module Frameit
  ...
  module Devices
    ...
    GOOGLE_PIXEL_6_PRO ||= Device.new("google-pixel-6-pro", "Google Pixel 6 Pro", 10, [[1440, 3120], [3120, 1440]], 512, Color::CLOUDY_WHITE, Platform::ANDROID)
    GOOGLE_PIXEL_SLATE ||= Device.new("google-pixel-slate", "Google Pixel Slate", 10, [[2000, 3000], [3000, 2000]], 293, nil, Platform::ANDROID)
